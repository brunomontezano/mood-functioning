...
# Quem possui outros transtornos -----------------------------------------------
library(tidymodels)

# Predicao em sujeitos com outros transtornos
# Filtrar pelo t1: 
#  OR (teptat_t1, tocat_t1, tagat_t1, pancfo_t1, pansfo_t1, agoraat_t1, fobsoa_t1)
# AND (edmat_t1 == 0 AND edmmel_t1 == 0 AND maniahipo_t1 == 0)
...
# Predicao em sujeitos saudaveis
# Filtrar pelo t1: TUDO DO PRIMEIRO PARENTESES == 0
#  AND (teptat_t1 == 0, tocat_t1, tagat_t1, pancfo_t1, pansfo_t1, agoraat_t1, fobsoa_t1)
# AND (edmat_t1 == 0 AND edmmel_t1 == 0 AND maniahipo_t1 == 0)




raw %>% select(teptat_t1, tocat_t1, tagat_t1, 
               pancfo_t1, pansfo_t1, agoraat_t1, 
               fobsoa_t1, edmat_t1, edmmel_t1, maniahipo_t1) %>% 
...
save.image("session/preprocessing_with_other_disorders.RData")

saveRDS(ds,
        file = "cache/dataset_with_other_disorders.rds")

write.csv(ds, file = "cache/ds_other_disorders_with_missings.csv")
